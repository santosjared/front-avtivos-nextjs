...
import { addEntrega } from "src/store/entrega";
...
const Entrega = ({ setStep, activos, register, setActivos, page, limit }: Props) => {
    ...
    const handleSave = () => {
        ...
        if (register?.otherLocation) {
            formData.append('otherLocation', register.otherLocation);
        }
        if (register?.otherGrade) {
            formData.append('otherGrade', register.otherGrade);
        }
