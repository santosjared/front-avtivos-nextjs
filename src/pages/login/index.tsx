...
const LoginPage = () => {
  ...
  return (
    <Box className='content-center'>
      <RightWrapper sx={{ border: `1px solid ${theme.palette.divider}`, borderRadius: 2 }}>
        <Box
          sx={{
            p: 7,
            height: '100%',
        ...
        >
          <BoxWrapper>
            ...
            <Box sx={{ mb: 6 }}>
              <TypographyStyled variant='h5'>{`Bienvenido al sistema de ${themeConfig.templateName}`}</TypographyStyled>
